...
export const DEFAULT_THEMES: ThemePreset[] = [
  {
    ...
    vars: {
      ...
      '--app-accent': '#5b8fff',
      '--app-node-grammar': '#6aa8ff',
      '--app-node-kanji': '#ffb347',
      '--app-node-vocab': '#39e58f',
      '--app-node-particle': '#ff7096',
      '--app-node-concept': '#9f83ff',
      '--app-node-root': '#8fd8ff',
    },
  },
  {
    id: 'graphite-amber',
    ...
    vars: {
      ...
      '--app-accent': '#f2a341',
      '--app-node-grammar': '#6db6ff',
      '--app-node-kanji': '#ffca72',
      '--app-node-vocab': '#66e5a8',
      '--app-node-particle': '#ff8a7d',
      '--app-node-concept': '#b296ff',
      '--app-node-root': '#7ee5d4',
    },
  },
  {
    id: 'deep-forest',
    ...
    vars: {
      ...
      '--app-accent': '#52c18f',
      '--app-node-grammar': '#7fb8ff',
      '--app-node-kanji': '#ffc46f',
      '--app-node-vocab': '#5ee0a2',
      '--app-node-particle': '#ff86a8',
      '--app-node-concept': '#a48fff',
      '--app-node-root': '#80e9dd',
    },
  },
]
